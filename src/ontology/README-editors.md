These notes are for the EDITORS of not
...
Make sure you have an ID range in the [idranges file](not-idranges.owl)

If you do not have one, get one from the maintainer of this repo.

The editors version is [not-edit.owl](not-edit.owl)

** DO NOT EDIT not.obo OR not.owl in the top level directory **

[../../not.owl](../../not.owl) is the release version

To edit, open the file in Protege. First make sure you have the repository cloned, see [the GitHub project](https://github.com/drseb/negation-ontology) for details.
 ...
 * [not-idranges.owl](not-idranges.owl)
...
This generates derived files such as not.owl and not.obo and places
 ...
 * https://github.com/drseb/negation-ontology/releases
 * https://github.com/drseb/negation-ontology/releases/new
...
what is in the `owl:versionIRI` of the derived not.owl (`data-version` in
not.obo). This will be today's date.
 ...
 * http://purl.obolibrary.org/obo/not.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/not/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/drseb/negation-ontology.svg?branch=master)](https://travis-ci.org/drseb/negation-ontology)

Note: if you have only just created this project you will need to authorize travis for this repo.

 1. Go to [https://travis-ci.org/profile/drseb](https://travis-ci.org/profile/drseb)
 2. click the "Sync account" button
 3. Click the tick symbol next to negation-ontology
