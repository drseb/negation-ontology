 ...
 * [not.yml](not.yml)
     * Determines how your purl.obolibrary.org/obo/not/ redirects will be handled
     ...
     * Paste in the contents of [not.yml](not.yml)
 ...
 * [not.md](not.md)
     ...
     * Paste in the contents of [not.md](not.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
